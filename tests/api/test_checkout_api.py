...
class TestCheckoutAPI:
    ...
    def test_place_order_international_user(self, endpoints, user_data):
        """Test checkout with international user data."""
        base = endpoints["checkout"]
        
        # Use international user data from JSON
        payload = user_data["valid_users"]["international_user"]
